        ...
        <View key={index} style={styles.industryContainer} >
          ...
          <View>
            <View style={styles.industryTextContainer}>
              <Text style={styles.industryText}>{stock.property}{industryLength}</Text>
                ...
                return (
                  <View style={styles.lowerIndustryRow}>
                    ...
                    <View style={{display: 'flex', flexDirection: 'column'}}>
                        <Text style={{fontFamily: 'Medium', fontSize: 18}}>{stock.company}</Text>
                        <Text style={{fontFamily: 'Regular', fontSize: 14}}>{stock.ticker}</Text>
                    </View> 
